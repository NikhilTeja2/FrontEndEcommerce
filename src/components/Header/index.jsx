...
function Header() {
    ...
    return (<>
        <Box>
            <AppBar position="static" sx={{ backgroundImage: 'linear-gradient(to right, #d16ba5, #c777b9, #ba83ca, #aa8fd8, #9a9ae1, #8aa7ec, #79b3f4, #69bff8, #52cffe, #41dfff, #46eefa, #5ffbf1)' }}>
                ...
                <Toolbar>
                    ...
                    <Box sx={{ marginRight: '10px', color: 'white',paddingLeft:'11px' }}>
                        
                        <Button sx={{ color: 'black' }} onClick={() => navigate('/')}>meeshow</Button>
                    </Box>
                    ...
                    {currentUser ? (
                        ...
                        <Button color="inherit" sx={{ color: 'black' }} onClick={() => navigate(`/signin`)}>
                            Sign in
                        </Button>
                    )}
                    <Box sx={{ marginLeft: 5 }} />
