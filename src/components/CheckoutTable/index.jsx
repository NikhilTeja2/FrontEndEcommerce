...
export default function CheckoutTable() {
    ...
    return (
        <>  
           {currentUser && <h2>Hey!!! {currentUser}</h2>} 
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                    <TableHead>
                        <TableRow style={{ backgroundColor: 'palevioletred', color: 'white' }}>
                    ...
                    <TableBody>
                        {rows.map((row) => (
                            ...
                            >
                                ...
                                /></TableCell>
                                <TableCell align="center" style={{ color: '#555', fontSize: '14px' }}>{row.name}</TableCell>
                                <TableCell align="center" style={{ color: '#555', fontSize: '14px' }}>{row.price}</TableCell>
                                <TableCell align="center" style={{ color: '#555', fontSize: '14px' }}>
                                ...
                                <TableCell align="center" style={{ color: '#555', fontSize: '14px' }}>{row.quantity * row.price}</TableCell>
                            </TableRow>
                        ))}
